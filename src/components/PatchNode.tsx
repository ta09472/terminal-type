          ...
          <div className=" overflow-auto px-9 flex-col gap-4">
            ...
            <div className="mb-4">
              <div className="pb-4 flex justify-between  items-center">
                <div>0.4 패치내역</div>
                <div className="text-base text-neutral-700">2024.4.16</div>
              </div>
              <div className="text-sm flex flex-col gap-4">
                <div>
            ...
            <div className="mb-4">
              <div className="pb-4  flex justify-between  items-center">
                <div>0.3 패치내역</div>
                <div className="text-base text-neutral-700">2024.4.15</div>
              </div>
              <div className="text-sm flex flex-col gap-4">
                <div>
            ...
            <div>
              <div className="pb-4  flex justify-between  items-center">
                <div>0.2 패치내역</div>
                <div className="text-base text-neutral-700">2024.4.14</div>
              </div>
              <div className="text-sm flex flex-col gap-4">
